...
// We know that functions are first class citizens so we can take a function and pass it into another functions here that function that is passed inside fucntion are called callback functions
